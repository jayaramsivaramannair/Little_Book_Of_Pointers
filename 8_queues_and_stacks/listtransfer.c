...
// this what is going to be in the list
...
LIST src;							// this is the 'source' list
LIST dst;							// this is the 'destination' list
...
int main() {
	...
	// In general, it is usually better to re-use something which has been tested and works rather than something new which may have errors.
